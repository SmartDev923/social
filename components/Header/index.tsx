            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-body-color/10 dark:border-white/10 lg:hidden">
                    {isAuthenticated ? (
                      <>
                        <Link
                          href="/admin"
                          className="block px-4 py-2 text-base font-medium text-dark hover:text-primary dark:text-white/70 dark:hover:text-white mb-2"
                      ...
                      <>
                        ...
                        <Link
                          href="/signup"
                          className="block w-full rounded-sm bg-primary px-4 py-2 text-base font-medium text-white shadow-btn transition duration-300 hover:bg-opacity-90 text-center"
                          onClick={() => setNavbarOpen(false)}
                        >
                          Sign Up
                        </Link>

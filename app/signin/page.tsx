  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.isAdmin) {
        ...
        // Store credentials for validation on app load
            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded bg-white px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                <p className="mb-11 text-center text-base font-medium text-body-color">
                  Access your Talentgauges dashboard to create assessments and review candidates.
                </p>
                  ...
                  <div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
                    <div className="mb-4 sm:mb-0">
                      <label htmlFor="checkboxLabel" className="flex cursor-pointer select-none items-center text-sm font-medium text-body-color">
                        <input type="checkbox" id="checkboxLabel" className="peer sr-only" aria-label="Keep me signed in" />
